...
async def reduce_false_positives(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="An error occurred while reducing false positives."
        )
...
async def generate_remediation(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="An error occurred while generating remediation."
        )
...
async def explain_finding(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="An error occurred while explaining the finding."
        )
